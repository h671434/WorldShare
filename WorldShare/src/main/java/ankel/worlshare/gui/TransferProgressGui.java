...
public class TransferProgressGui extends LoadingGui {
	...
	public TransferProgressGui(Minecraft p_i225928_1_, IAsyncReloader p_i225928_2_, Consumer<Optional<Throwable>> p_i225928_3_) {
  	...
  	public static void registerTextures(Minecraft p_212970_0_) {
  		p_212970_0_.getTextureManager().register(MOJANG_STUDIOS_LOGO_LOCATION, new MojangLogoTexture());
   }
  	...
  	static class MojangLogoTexture extends SimpleTexture {
  		...
  		protected SimpleTexture.TextureData getTextureImage(IResourceManager p_215246_1_) {
  			...
  			try (InputStream inputstream = vanillapack.getResource(ResourcePackType.CLIENT_RESOURCES, MOJANG_STUDIOS_LOGO_LOCATION)) {
